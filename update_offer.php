...
$conn = $_SESSION['conn'];
$id = $_GET['id'];
$select = mysqli_query( $conn, "select * from offers where id='$id'" );
$row = mysqli_fetch_array( $select );
if(isset($_POST['sub']))
{
    $obj -> upd_offer($_POST['txtdate'],$_POST['txtexp'],$_POST['txtdis'],$_POST['txtlink'],$_POST['txtcod'],$_POST['txtstore'],$_POST['txtcat']);
}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="address">Discription</label>
                                            <input type="url" value="<?php echo $row[4];?>"  class="form-control" name="txtlink" placeholder="Discription and detail of your coupon">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label for="Coupon Code">Offer Code</label>
