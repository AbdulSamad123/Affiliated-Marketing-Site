...
$sql = "SELECT deals.date, deals.exp_date, deals.discription, deals.link, deals.deal_code, store.logo, store.name, store.website, store.content
FROM store JOIN deals on store.id=deals.store where deals.id='$rec_id'";
