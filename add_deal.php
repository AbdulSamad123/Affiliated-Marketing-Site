...
if(isset($_POST['sub']))
{
	$obj->add_deal($_POST['txtdate'],$_POST['txtexp'],$_POST['txtdis'],$_POST['txtlink'],$_POST['txtcod'],$_POST['txtstore'],$_POST['txtcat']);
}
                                    ...
                                    <form autocomplete="off" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <small class="form-text text-muted">Please enter expiry date of deal</small>
                                           </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="url" class="form-control" name="txtlink" placeholder="Link of the deal">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="txtcod" placeholder="Deal Code">
                                            </div>
                                            <div class="form-group col-md-4">
